...
class _EventTileState extends State<EventTile> with TickerProviderStateMixin {
  ...
  void _handleOnTap() {
    Navigator.of(context).push(
      MaterialPageRoute(
        builder: (context) {
          return AdminPanel(edata: widget.eventData, isAdmin: true);
        },
      ),
    );
  }
  ...
  Widget build(BuildContext context) {
    ...
    var eventDay = dayformtr.format(dt);
    var eventTime = tformtr.format(dt);
                        ...
                        children: [
                          ClipRRect(
                            ...
                            child: SizedBox(
                              ...
                              child: buildImage(
                                url: widget.eventData.eventThumbnail,
                              ),
                            ),
                          ),
