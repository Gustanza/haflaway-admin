...
class _MyAccountScreenState extends State<_MyAccountScreen> {
  ...
  @override
  Widget build(BuildContext context) {
    final name = '${widget.userr.firstName} ${widget.userr.lastName}'.trim();
    final initials =
        name
            .split(' ')
                      ...
                      children: [
                        Expanded(
                          child: _statCard(
                            ...
                            label: 'AFFILIATIONS',
                            value: eventsAffils != null ? '${eventsAffils}' : '—',
                            sub: 'events affiliated',
                          ),
                        ),
                        ...
                        Expanded(
                          child: _statCard(
                            ...
                            label: 'BALANCE',
                            value: formatMoney(widget.userr.balance ?? 0),
                            sub: 'TZS · wallet',
                          ),
                        ),
                      ],
                    ...
                    child: Column(
                      children: [
                        ...
                        _settingRow(
                          ...
                          label: 'Help & Support',
                          sub: 'Contact support',
                          onTap: () async => await callNumber("+255625689904"),
                        ),
                      ],
                    ),
                  ),
