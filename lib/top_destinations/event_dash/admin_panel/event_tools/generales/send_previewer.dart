...
class SendPreviewerState extends State<SendPreviewer> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: appBar(
        ...
        actions: Row(
          children: [TextButton(child: Text("Tuma"), onPressed: confirmSend)],
        ),
      ),
  ...
  buildTemplates(List<WsapTemplate> temps) {
    ...
    return SingleChildScrollView(
      padding: EdgeInsets.only(top: psm, right: psm, left: psm, bottom: psm),
      child: Column(
        children: [
          Text(
            "Walengwa: (${widget.senderList.length})",
            style: TextStyle(
              fontSize: fsm + 2,
              color: Colors.green,
          ...
          Text(
            "Chagua template ya kutumia katika campaign hii",
